...
<table>
  ...
  <tbody>
    ...
    <tr><th colspan="4" style="text-align:left;background:#f5f7fa;padding:8px 10px;border-top:2px solid #e5e7eb;">Core Banking (CASA, Onboarding & Compliance)</th></tr>
    ...
    <tr><th colspan="4" style="text-align:left;background:#f5f7fa;padding:8px 10px;border-top:2px solid #e5e7eb;">Lending</th></tr>
    ...
    <tr><th colspan="4" style="text-align:left;background:#f5f7fa;padding:8px 10px;border-top:2px solid #e5e7eb;">Trade Finance</th></tr>
    ...
    <tr><th colspan="4" style="text-align:left;background:#f5f7fa;padding:8px 10px;border-top:2px solid #e5e7eb;">Governance, Risk & Observability</th></tr>
    ...
    <tr><th colspan="4" style="text-align:left;background:#f5f7fa;padding:8px 10px;border-top:2px solid #e5e7eb;">Data & RM Productivity</th></tr>
    ...
    <tr><th colspan="4" style="text-align:left;background:#f5f7fa;padding:8px 10px;border-top:2px solid #e5e7eb;">Policy & Operations</th></tr>
    ...
    <tr><th colspan="4" style="text-align:left;background:#f5f7fa;padding:8px 10px;border-top:2px solid #e5e7eb;">Wealth & Advisory</th></tr>
    ...
    <tr><th colspan="4" style="text-align:left;background:#f5f7fa;padding:8px 10px;border-top:2px solid #e5e7eb;">ESG & Sustainable Finance</th></tr>
    ...
    <tr><th colspan="4" style="text-align:left;background:#f5f7fa;padding:8px 10px;border-top:2px solid #e5e7eb;">Enterprise, HR & Tools</th></tr>
